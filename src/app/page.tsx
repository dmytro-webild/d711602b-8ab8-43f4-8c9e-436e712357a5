...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      leftCarouselItems={[
        ...
        },
        {
          ...
          imageAlt: "Portrait of engineer using computer for charts design",
        },
      ]}
      rightCarouselItems={[
        {
          ...
          imageAlt: "Consulenza professionale",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-office-worker-woman-standing-office-desk-with-documents-using-computer-with-confident-serious-expression-face-working-office_141793-21294.jpg",
      ...
      avatarText="Oltre 200 clienti soddisfatti si affidano a noi."
      marqueeItems={[
        {
          type: "text",
          text: "Contabilità Fiscale",
        },
        {
          type: "text",
          text: "Consulenza Lavoro",
        },
        {
          type: "text",
          text: "Revisione Legale",
        },
        {
          type: "text",
          text: "Gestione Societaria",
        },
        {
          type: "text",
          text: "Pianificazione Patrimoniale",
        },
      ]}
    />
  </div>
      ...
      bulletPoints={[
        {
          ...
          description: "Gestione accurata delle imposte.",
        },
        {
          title: "Gestione Lavoro",
          description: "Supporto completo paghe e contributi.",
        },
        {
      ...
      features={[
        {
          ...
          description: "Dichiarazioni, bilanci e adempimenti.",
          buttonIcon: "Calculator",
          imageSrc: "http://img.b2bpic.net/free-photo/businessman-examining-document_1098-22046.jpg",
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          value: "100%",
          description: "Precisione garantita",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Dove si trova lo studio?",
          content: "Siamo in Via Luigi Lilio 22, all'Eur, Roma.",
        },
        {
          id: "q2",
        ...
        {
          id: "q3",
          title: "Offrite consulenza online?",
          content: "Sì, supportiamo incontri remoti via call.",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "3",
          title: "Competenti",
          quote: "Consigli validissimi per il mio lavoro.",
          name: "Luca V.",
          role: "Commerciante",
        ...
        },
        {
          id: "4",
          title: "Consigliato",
          quote: "Molto precisi con le scadenze.",
          name: "Anna P.",
        ...
        {
          id: "5",
          title: "Servizio Ottimo",
          quote: "Supporto completo e affidabile.",
          name: "Roberto D.",
          role: "Responsabile",
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "Via Luigi Lilio 22, Eur",
              href: "#",
            },
            {
              label: "info@forte-massucci.it",
              href: "mailto:info@forte-massucci.it",
            },
          ],
        },
        {
